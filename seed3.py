...
LOG = r"C:\Users\GUSTAVE KUTSHE\.openclaw-autoclaw\workspace\seed_log.txt"
...
students = [
    ...
    {"matricule": "2025-003", "first_name": "Joel", "last_name": "Tshimanga", "dob": "2009-01-10", "gender": "M", "class_id": "2", "parent_name": "Papa Tshimanga"},
    {"matricule": "2025-004", "first_name": "Divine", "last_name": "Lukaku", "dob": "2009-05-30", "gender": "F", "class_id": "2", "parent_name": "Maman Lukaku"},
    {"matricule": "2025-005", "first_name": "Patrick", "last_name": "Mokobe", "dob": "2008-11-05", "gender": "M", "class_id": "3", "parent_name": "Papa Mokobe"},
]
for s in students:
    post("/students/add", s)
...
# Grades
grades = [
    {"student_id": "1", "subject_id": "1", "term": "1er Trim", "exam_type": "Examen", "score": "78", "max_score": "100"},
...
attendance = [
    {"student_id": "1", "date": td, "status": "present"},
    {"student_id": "2", "date": td, "status": "present"},
    {"student_id": "3", "date": td, "status": "absent"},
    {"student_id": "4", "date": td, "status": "retard"},
    {"student_id": "5", "date": td, "status": "present"},
]
for a in attendance:
